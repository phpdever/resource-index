...
目前你所看到的内容由我收集并整理，如果你有优秀的博客或社区需要推荐或自荐，请点：[我要提交](https://github.com/phpdever/resource-index/issues/1)
...
博客名称 | 博客简介 
----- | -----
[Kaisa](https://ciweigg2.github.io/) | Spring Cloud、Docker、Kubernetes，及其相关生态的技术
[小马哥的技术博客](https://mercyblitz.github.io/) |架构设计，设计模式，框架使用，源码分析
[周立的博客](http://www.itmuch.com/) | Spring Cloud、Docker、Kubernetes，及其相关生态的技术
[嘟嘟独立博客](http://tengj.top/) | Spring Boot相关
[程序羊](https://www.codesheep.cn/) | 虚拟化、容器化、API化和微服务化的WEB技术
[李乾坤的博客](https://qiankunli.github.io/) | 我们将自己很大一部分时间献给了网络，从幼年到成年，网络中有我们成长的足迹
[码酱博客](http://luokangyuan.com/) | 只求分享与免费，不隐含扭曲的价值观，而是整合并充盈正能量
[Jitwxs](https://www.jitwxs.cn/) | 喜欢体验各种各样的科技产品，热爱 Coding
[纯洁的微笑](http://www.ityouknow.com/) | 分享技术，分享生活
[谢天华的博客](https://www.xieth.com/) | 所谓天才，不过是每一天的积累成才
[田小波的技术博客](http://www.tianxiaobo.com/) | 非著名程序员
[telami](https://www.telami.cn/) | SpringCloud、Docker、Vue、MiniProgram
[方志朋的博客](https://www.fangzhipeng.com/) | 生命不息，奋斗不止
[程序猿DD](http://blog.didispace.com/) | 精选企业应用架构实践中非常实用的干货内容
[LiaoCan Blog](https://liaocan.top/) | 专注web前后端，大数据，数据治理等技术。
[程序猿start刘](http://www.firstcode.xyz:8088/) | 沉迷于Java开发，专注于Web后端技术，追求新技术探索
[徐靖峰个人博客](https://www.cnkirito.moe) | 探讨 Java 生态的知识点，内容覆盖分布式服务治理、微服务、性能调优、各类源码分析
[地瓜哥](https://www.diguage.com/) | 分享技术带来的喜悦
[知秋](https://muyinchen.github.io/) | 一叶知秋
[方志朋的专栏](生命不息，奋斗不止) | 生命不息，奋斗不止

### PHP 博客

博客名称 | 博客简介 
----- | -----
[风雪之隅](http://www.laruence.com/) | 左手代码右手诗
[周梦康](https://mengkang.net/) | 快乐 coding，认真生活
[陈捷的博客](https://www.chenjie.info/) | PHP码农，爱编程，爱折腾
[博学无忧](https://www.bo56.com/) | 把工作中遇到的问题记录到这里
[forecho 的独立博客](https://blog.forecho.com/) | 把生命浪费在美好的事物上
[韩天峰(Rango)的博客](http://rango.swoole.com/) | trim(me)，省下一些时间和空间。
[洋沙居士](http://guweigang.com/) | 山不过来，我就过去
[沈逸的个人站点](http://www.hishenyi.com/) | 分享互联网观点、编程心得、随口说说、IT在线教育后来者
[一颗西瓜籽](https://huanghantao.github.io/) | 简洁些、干净些、直接些
[heiyeluren的blog](https://blog.csdn.net/heiyeshuwu) | 黑夜路人的开源世界
[沈唁志](https://qq52o.me/) | 一个PHPer的成长之路

### Go 博客

博客名称 | 博客简介 
----- | -----
[敬维](https://jingwei.link/) | CI/CD的践行者，一个探寻最佳实践的人。
[利强的博客](https://liqiang.io/) | 后端开发小学生
...
[jasper的技术小窝](http://www.opscoder.info/) | 关注DevOps、运维监控、Python、Golang、开源、大数据、web开发、互联网
[LittleFeng的博客](https://allenwind.github.io/) |后端技术、分布式、Python、Go
[老高的技术博客](https://blog.phpgao.com/) |与其美丽的牺牲，倒不如美丽的活到最后一刻
[风笑痴](http://lunny.info/) | 一个脱离了低级懒惰的人
[大桥下的蜗牛](https://blog.lab99.org/) |无善无恶心之体，有善有恶意之动，知善知恶是良知，为善去恶是格物
[三月沙](https://sanyuesha.com/) | 分享互联网技术，创业及产品的个人观点
[Legendtkl](http://legendtkl.com/) |A man can be destroyed but not be defeated. – “The old man and the sea”
[行思錄](https://liudanking.com/) |斗在一线的架构师，分享架构之道，技术远景
